...
include('blog.html'); //connect the html page
mysql_close($dbhandle); //close connection
?>

<!--  I think Commented part is not necessary to blog.php-->

<!--
<html>
<head>
	<meta charset="UTF-8">
	<title>sign up - Student Accommodation Website</title>
				...
				<p>
					...
					<!--  Interactive Login - START 
							...
							<!-- <div class="row colored">
								<div id="contentdiv" class="contcustom">
									...
									<div>
										...
										<!--<a href="student.html"><input type="submit" name="submit" value="Sign in" >
										<div>
						...
						.contcustom {
							...
							right: 0;
							margin: 10px auto;
							background : -moz-linear-gradient(#FF9900,#ffffaa,#ffffcc,#ffffbb,#FF9900,#ffffaa);
							padding: 20px;
						}
